...
module.exports = function(interrupts = {}) {
  ...
  return function(req, res) {
    ...
    if (typeof fields === 'object' && !Array.isArray(fields) && typeof fields[pluralize(Model.identity)] === 'string') {
      project.select = fields[pluralize(Model.identity)].split(',');
    }
          ...
          parallel(
            {
              ...
              records(done) {
                ...
                const query = Model.find(project)
                  .where(criteria)
